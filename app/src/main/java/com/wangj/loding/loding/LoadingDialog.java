...
public class LoadingDialog {
    ...
    private LoadingBuilder mLoadingBuilderType;
    ...
    public LoadingDialog setLoadingBuilder(@NonNull TestBuilder type) {
    ...
    public Dialog create() {
        ...
        LoadingView zLoadingView = (LoadingView) contentView.findViewById(R.id.z_loading_view);
